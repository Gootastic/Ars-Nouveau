...
public class LangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_nouveau.page.relay_deposit", "Depositors operate like Source Relays except that they will automatically deposit Source into unlinked Source Jars within a 5 block sphere.");
        add("ars_nouveau.page.relay_warp", "Warpers operate like Source Relay: Splitters except that they can transfer Source an unlimited distance between other Warpers in the same dimension.\n\nWhen transporting over distances greater than 30 blocks, there is a chance that some Source will be lost during the transfer.");
        ...
        add("ars_nouveau.page.agronomic_sourcelink", "Agronomic Sourcelinks generate a small amount of Source from natural crop and tree growth within a 15 block sphere.\n\nBonus Source is generated for magical plants such as Mageblooms, Sourceberries, Archwood Saplings and Archfruit.");
        add("ars_nouveau.page.source_jar", "Source Jars automatically store Source produced by Sourcelinks within a 5 block cube. The Source can then be used to fuel various magical processes.\n\nJars can broken and moved without losing their contents. Source can be moved to other jars via Source Relays.\n\nComparators can be used to emit a Redstone signal based on the jar's fill level.");
        add("ars_nouveau.page1.volcanic_sourcelink", "Volcanic Sourcelinks generate source by consuming burnable items that are either dropped nearby or placed on an adjacent Arcane Pedestal.\n\nMore Source is produced when consuming items with higher fuel values. Archwood Logs, especially Blazing Archwood Logs, produce more Source than normal logs. Consuming Fire Essence produces yields rivaling Lava.\n\nWhile collecting Source, the Sourcelink also occasionally produces Heat which slowly converts certain blocks below it. Stone Blocks become Magma Blocks which then become Lava.");
        add("ars_nouveau.page.alchemical_sourcelink", "Alchemical Sourcelinks generate Source by consuming potions from adjacent Potion Jars. More Source is produced when consuming potions with longer lengths or higher levels.\n\nThis Sourcelink can produce exceptional amounts of Source, especially when consuming complex melded potions made with a Potion Melder.");
        add("ars_nouveau.page.vitalic_sourcelink", "Vitalic Sourcelinks generate a moderate amount of Source from breeding and mob death and passively generate Source from the existence of baby mobs in a 15 block sphere.\n\nBaby mobs in range will also mature more quickly.");
        add("ars_nouveau.page.mycelial_sourcelink", "Mycelial Sourcelinks generate Source by consuming food items that are either dropped nearby or placed on an adjacent Arcane Pedestal. More Source is produced when consuming more nourishing foods, and Sourceberry foods produce even more.\n\nThe Sourcelink will also convert Grass or Dirt in a 3x3 below it into Mycelium and grow mushrooms periodically.");
        ...
        add("ars_nouveau.page.relay", "Source Relays and their many variants transport Source between Source Jars and other Relays.\n\nTo transfer Source between jars, use the Dominion Wand on the Source Jar to transfer from and then use it on a Relay. Relays can be linearly chained together or linked to a Source Jar where Source will be deposited.\n\nSource Relays have a 30 block sphere range.\n\nTo clear connections, sneak while using the Dominion Wand on the Relay.");
        add("ars_nouveau.page.relay_splitter", "Splitters operate like Source Relays except that they support transferring to and from multiple jars at once.\n\nSplitters have a much larger through-put than the Source Relay and will split this throughput across all of its jars.");
        add("ars_nouveau.page1.enchanting_apparatus", "The Enchanting Apparatus can be used to craft powerful objects or directly enchant gear with specific enchantments.\nTo get started, place an Enchanting Apparatus on top of an Arcane Core and place Arcane Pedestals within a 3 block cube of the apparatus.\nNext, place the recipe ingredients onto the pedestals. Finally, insert the item to be in enchanted into the apparatus to start crafting.\nSome more powerful recipes also require Source to craft.");
        add("ars_nouveau.page1.imbuement_chamber", "The Imbuement Chamber allows the conversion of Amethyst Shards or Lapis Lazuli into Source Gems. By placing three Arcane Pedestals bearing certain items adjacent to the chamber, Source Gems can be imbued further into Essences.\nThe chamber slowly accumulates its own Source for recipes. Source Jars may be placed within a 3 block cube to speed up the process.");
        ...
        add("ars_nouveau.spell_turrets", "Spell Turrets");
        add("ars_nouveau.page1.basic_spell_turret", "Spell Turrets use Source to cast assigned spells with Touch or Projectile forms when given a Redstone signal.\nSpells can set by sneak clicking the turret while holding your Spellbook with the desired spell selected or by using an inscribed Spell Parchment on the turret.\nSpell Turrets pull from Source Jars within a 21 block cube.\nTurrets can access inventories adjacent to them to work with certain Glyphs such as Place Block, Item Pickup and Interact. Check them out in the Glyph Index to learn more.");
        ...
        add("ars_nouveau.page3.basic_spell_turret", "Timer Spell Turrets will automatically fire on a built-in timer defaulted to 1 second.\nThe time may be increased by right-clicking the block and decreased by punching adding or removing 1 second respectively. Changing the timer while sneaking will configure it in 10 second intervals instead.\nTo prevent changes to the timer, the turret can be locked and unlocked with a Dominion Wand.\nSetting the turret to 0 seconds or providing a Redstone signal will disable it.\nGlyphs such as Projectile, Touch, Sensitive and Redstone Signal are cast for free.");
        add("ars_nouveau.page1.bookwyrm_charm", "Bookwyrm Charms can be used on a Storage Lectern to assign a Bookwyrm to it and increase the number of inventories it may access.\nTo get the charms, perform a Ritual of Awakening and augment it with any number of Books and Quills equal to the desired number of charms. Then, activate the ritual to receive the charms.\nBookwyrms can be dyed red, blue, green, purple, black, or white.");
        add("ars_nouveau.page2.bookwyrm_charm", "Bookwyrms will drop their charm if they die or are dispelled.");
        ...
        add("ars_nouveau.page1.amethyst_golem_charm", "Amethyst Golems will harvest, grow, and collect Amethyst near its home.\nTheir charm can be obtained by performing the Ritual of Awakening near a Budding Amethyst block.");
        add("ars_nouveau.page2.amethyst_golem_charm", "");
        add("ars_nouveau.page3.amethyst_golem_charm", "Summon the Amethyst Golem by using its charm on a block. Before an Amethyst Golem will perform tasks, they must first have a home. This can be set by using a Dominion Wand on the golem and then on a block.\nThe golem's home is a 10 block cube centered on its home's position.");
        add("ars_nouveau.amethyst_farming", "Farming Amethyst");
        add("ars_nouveau.page4.amethyst_golem_charm", "Once a home has been set, the Amethyst Golem will begin performing tasks over time.\nThey will convert Amethyst Blocks into Budding Amethyst, harvest Amethyst Clusters, speed up Budding Amethyst growth, and pick up and store Amethyst Shards.");
        add("ars_nouveau.amethyst_storage", "Storing Amethyst");
        add("ars_nouveau.page5.amethyst_golem_charm", "If an Amethyst Golem's home has been set to an inventory, golems will pick up and store Amethyst Shards in their bounded inventory block.\nIf their home is not an inventory, they will simply ignore items on the ground.");
        ...
        add("ars_nouveau.page.relay_collector", "Collectors operate like Source Relays except that they will automatically collect Source from unlinked Source Jars within a 5 block sphere.");
        ...
        add("ars_nouveau.page1.mob_jar", "Containment Jars allow you to capture and store entities for transport, base automation, or decoration.\nEntities are capture by performing a Ritual of Containment near the ritual site. See the entry in the Ritual Index for more info.\nMobs can be released by casting Dispel on the jar. Items can be removed by interacting.\nNote blocks placed above a jarred mob will play their ambient sound.\nMany mobs can be interacted with and will continue to simulate while inside the jar offering a unique way to create functional and performant farms.\nDrygmies will also treat jarred mobs as normal mobs.");
        ...
        add("mob_jar.allay", "Jarred Allays will pickup items within a 5 bock sphere and deposit them in adjacent inventories.\nGiving an Allay an item will cause it to only pickup that item. Giving it an Item Scroll cause it to pickup any item that matches those on the scroll. They will also respect any filters placed on the adjacent inventories.");
        ...
        add("ars_nouveau.grates", "Grates");
        add("ars_nouveau.page1.archwood_grate", "Liquids placed on top of grates will be transported down through them, waterlogging the block below if possible.\nInteracting with the grate will also act as if you are interacting with the block below it, allowing you to easily bucket liquids.\nItems and projectiles will also pass through grates freely.");
        ...
        add("ars_nouveau.page1.alakarkinos_charm", "Alakarkinos can sift Sand and Gravel to produce items from archaeology sites.\nThey can be found on beaches and will give you a token if they receive a Pottery Sherd of any kind.");
        add("ars_nouveau.page2.alakarkinos_charm", "These fabulous crabs love to dance to music!");
        add("ars_nouveau.page3.alakarkinos_charm", "Alakarkinos can be summoned anywhere by using its charm on a block.\nTo set Alakarkinos' home, use a Dominion Wand to bind it to a Chest or other inventory.");
        add("ars_nouveau.page4.alakarkinos_charm", "Alakarkinos will seek out Sand or Gravel placed within a 3 block horizontal and 1 block vertical cuboid of its bound inventory.\nIn order to convert blocks into items, Source must be provided near its bound inventory. After some time and a short performance, Alakarkinos will destroy the Sand or Gravel, and insert items into the inventory.");
